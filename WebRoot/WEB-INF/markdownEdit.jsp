...
<html lang="zh">
    ...
    <body>
        <div id="layout">
            <header>
                <h1 style="font-size:50px" contenteditable="true" id="blog_title">${article.title}</h1>
                <!-- Single button -->
                <br>
                <form id="uploadForm" >
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $.get('${proPath}/article/articleMd.action?articleId=${ article.articleId }', function(md){
             ...
             //  alert(testEditor.getMarkdown());       // 获取 Markdown 源码
               ...
               // alert('title=' + title + '&content=' + testEditor.getHTML() + '&imgUrl=' + imgUrl + '&type=' + type + '&markdown=' + testEditor.getMarkdown());               
                $.ajax({ 
                    cache: true,
                    type: "POST",
                    url:'${proPath}/article/save.action',
