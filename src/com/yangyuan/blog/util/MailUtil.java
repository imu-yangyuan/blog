...
public class MailUtil {
    ...
    private final static String myEmailAccount = "XXX@163.com";
    private final static String myEmailPassword = "XXX";
    ...
    private static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String subject,String  Content) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "寒江独钓", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "Blog用户", "UTF-8"));
    ...
    public static void main(String[] args) {
    	MailUtil.sendMail("yangyuan@imudges.com","主题","正文");
	}
}
